...
// Legacy computeChange / multiplierOverride variants are preserved so rounds
// persisted before the four-layer redesign still validate — they are mapped to
// narrativeOnly by the apply path.
