...
export default defineSchema({
    ...
    submissions: defineTable({
        ...
        status: v.union(v.literal("draft"), v.literal("submitted"), v.literal("graded"), v.literal("resolved")),
    })
    ...
    rounds: defineTable({
        ...
        resolvedEvents: v.optional(v.array(v.object({
            id: v.string(),
        ...
        worldStateAfter: v.optional(v.object({
            capability: v.number(),
            alignment: v.number(),
            tension: v.number(),
            awareness: v.number(),
        ...
        labsAfter: v.optional(v.array(v.object({
            name: v.string(),
            roleId: v.string(),
            computeStock: v.number(),
            rdMultiplier: v.number(),
